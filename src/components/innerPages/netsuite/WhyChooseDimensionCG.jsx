...
import { Award, Shield, Globe, Settings } from 'lucide-react';
...
const WhyChooseDimensionCG = () => {
  ...
  return (
    <section ref={containerRef} className="relative overflow-hidden py-20 lg:py-32 bg-gradient-to-br from-[#F8FAFC] via-[#F1F5F9] to-white border-t border-slate-200">
      {/* Background Glows */}
      <div className="absolute left-0 top-20 w-[500px] h-[500px] rounded-full bg-[#0e4d9e]/5 blur-[180px] pointer-events-none" />
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(14,77,158,0.03),transparent_55%)] pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <div className="left-content w-full lg:w-5/12">
            ...
            <h2 className="text-4xl md:text-5xl xl:text-6xl font-bold leading-[1.05] tracking-tight text-[#000000]">
              Why Choose<br />
              <span className="text-[#0e4d9e]">DimensionCG</span><br />
              for Oracle NetSuite?
            </h2>

            <div className="mt-5 w-14 h-[3px] bg-[#0e4d9e] rounded-full" />
          ...
          <div className="right-content w-full lg:w-7/12 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {features.map((feature, idx) => (
                <div
                  key={idx}
                  className="feature-card group relative rounded-3xl bg-white p-8 border border-blue-100 shadow-[0_4px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_30px_70px_rgba(14,77,158,0.12)] hover:-translate-y-2 transition-all duration-500 overflow-hidden"
                  style={{ marginTop: (idx === 1 || idx === 3) ? '24px' : '0' }}
                >
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-50 to-white shadow-sm flex items-center justify-center text-[#0e4d9e] mb-6 relative z-10 transition-transform duration-500 group-hover:rotate-0 -rotate-12">
                    {feature.icon}
                  </div>
