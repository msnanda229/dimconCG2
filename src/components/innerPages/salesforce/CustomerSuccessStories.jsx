...
import { ArrowRight, Building2, TrendingUp, TrendingDown, Clock, Activity } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-[#000000]">
              Discover how leading organizations leverage DimensionCG and Salesforce to achieve remarkable business outcomes.
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl overflow-hidden border border-border shadow-sm flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 bg-slate-900 relative p-12 flex flex-col justify-between overflow-hidden min-h-[400px]">
            ...
            <img src="/images/manufacturing_scm.png" className="absolute inset-0 w-full h-full object-cover opacity-40" alt="Global Retailer" />
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold text-white leading-tight mb-4">
                Omnichannel transformation with Sales & Service Cloud
              </h3>
            </div>

            <div className="relative z-10 mt-12 pt-8 border-t border-white/20">
              <p className="text-slate-300 text-sm mb-2">Salesforce Solutions Implemented:</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-white/5 border border-white/10 rounded text-slate-200 text-xs">Sales Cloud</span>
                <span className="px-3 py-1 bg-white/5 border border-white/10 rounded text-slate-200 text-xs">Service Cloud</span>
                <span className="px-3 py-1 bg-white/5 border border-white/10 rounded text-slate-200 text-xs">MuleSoft</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 p-10 lg:p-14 story-content">
            ...
            <div className="mb-10">
              <h4 className="text-sm font-bold text-[#00a1e0] uppercase tracking-wider mb-3">The Challenge</h4>
              <p className="text-slate-600 leading-relaxed">
                The client struggled with disjointed customer data across retail stores and ecommerce platforms, resulting in inconsistent customer service and missed cross-sell opportunities.
              </p>
            </div>

            <div className="mb-12">
              <h4 className="text-sm font-bold text-[#00a1e0] uppercase tracking-wider mb-3">The Solution</h4>
              <p className="text-slate-600 leading-relaxed">
                DimensionCG implemented Sales & Service Cloud integrated via MuleSoft to their backend ERP. We deployed a unified agent console and automated lead routing for their B2B division.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="kpis-container grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div className="kpi-card p-5 bg-slate-50 rounded-xl border border-slate-100">
                  <div className="w-8 h-8 rounded-lg bg-blue-100 text-[#00a1e0] flex items-center justify-center mb-3">
                    <TrendingUp className="w-4 h-4" />
                  </div>
                  <div className="text-2xl font-bold text-[#000000] mb-1">
                    <span className="counter-val" data-target="35" data-suffix="%">0%</span>
                  </div>
                  <p className="text-xs text-slate-500">Increase in cross-sell revenue</p>
                </div>
                ...
                <div className="kpi-card p-5 bg-slate-50 rounded-xl border border-slate-100">
                  ...
                  <p className="text-xs text-slate-500">Reduction in case resolution time</p>
                </div>
                ...
                <div className="kpi-card p-5 bg-slate-50 rounded-xl border border-slate-100">
                  ...
                  <div className="text-2xl font-bold text-[#000000] mb-1">
                    <span className="counter-val" data-target="360" data-suffix="°">0°</span>
                  </div>
                  <p className="text-xs text-slate-500">Unified view of the customer</p>
                </div>
