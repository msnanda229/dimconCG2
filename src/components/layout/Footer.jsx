        ...
        <div className="footer-animate grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-14 lg:gap-10 mb-10 lg:mb-14">
          ...
          <div className="md:col-span-2 lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-6">
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <ul className="flex flex-col gap-2 text-sm md:text-base text-slate-500 font-medium">
                <li><Link to="services/ai-powered-erp" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>AI-Powered ERP</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/services/cloud-applications" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Cloud Applications</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/services/erp-implementation" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>ERP Implementation</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/services/data-migration" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Data Migration</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/services/crm-implementation" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>CRM Implementation</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/services" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>HCM Implementation</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                ...
                <li><Link to="/services" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Monitoring Services</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/services" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Performance Optimization</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
              </ul>
            </div>
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <ul className="flex flex-col gap-2 text-sm md:text-base text-slate-500 font-medium">
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Healthcare</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Manufacturing</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Finance</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Retail</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>E-Commerce</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>IT</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                ...
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Energy</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Hi-Tech</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/industries" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Hospitality</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <ul className="flex flex-col gap-2 text-sm md:text-base text-slate-500 font-medium">
                ...
                <li><Link to="/" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Careers</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Insights & News</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
                <li><Link to="/" className="hover:text-blue-600 transition-colors inline-flex items-center min-h-[44px] lg:min-h-0 relative group py-2 lg:py-0"><span>Contact Us</span><span className="absolute bottom-1 lg:-bottom-1 left-0 w-0 h-[1px] bg-blue-600 transition-all duration-300 group-hover:w-full"></span></Link></li>
              </ul>
            </div>
