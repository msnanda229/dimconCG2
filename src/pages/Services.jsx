                ...
                <div className="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
                    <div className="flex gap-2">
                        {srv.logos.map((logo, i) => (
                            <img key={i} src={logo} alt="Technology Logo" className="h-5 object-contain grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300" />
                        ))}
                    </div>
